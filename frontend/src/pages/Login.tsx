...
export default function Login() {
  const { login, googleLogin, facebookLogin, googleRedirectLogin, facebookRedirectLogin, isFirebaseActive } = useAuth();
        ...
        <div className="card">
          <div className="card-body">
            ...
            <div className="flex flex-col gap-3">
              <button
                type="button"
                onClick={async () => { setSocialLoading(true); setError(''); try { await googleLogin(); navigate('/dashboard'); } catch (e) { console.error('Google sign-in error:', e); const msg = (e as { code?: string }).code === 'auth/popup-blocked' ? 'Pop-up blocked by browser. Please allow pop-ups for this site, or use the redirect method below.' : 'Google sign-in failed.'; setError(msg); } finally { setSocialLoading(false); } }}
